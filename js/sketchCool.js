...
function draw(){
	const outTimes = floor(random(0, RANDOM_LIMIT + 1));
	const circleTimes = floor(random(0, RANDOM_LIMIT + 1));
	const rectTimes = floor(random(0, RANDOM_LIMIT + 1));
	const randoCircle = floor(random (1, 4))


	console.log(outTimes + " | " + circleTimes  + " | " + rectTimes)
	if(randoCircle % 2 == 0){
